...
export type ViewType = "dashboard" | "fichadas" | "employees" | "cierre"

const navigation: { name: string; view: ViewType; icon: typeof LayoutDashboard }[] = [
  { name: "Dashboard", view: "dashboard", icon: LayoutDashboard },
  { name: "Fichadas del Día", view: "fichadas", icon: Clock },
  { name: "Empleados", view: "employees", icon: Users },
  { name: "Cierre Mensual", view: "cierre", icon: FileText },
]
